...
#define MAX_BAG_ITEM_CAPACITY         1
#define MAX_PC_ITEM_CAPACITY          1
#define MAX_PYRAMID_BAG_ITEM_CAPACITY 1 // Values higher than 255 require free SaveBlock2 space.
